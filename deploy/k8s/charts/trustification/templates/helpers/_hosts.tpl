...
{{/*
Default host part of the report service.

Arguments (dict):
  * root - .
*/}}
{{- define "trustification.host.report" }}
{{- include "trustification.ingress.host" (dict "root" .root "ingress" .root.Values.modules.report.ingress "defaultHost" "report") }}
{{- end }}